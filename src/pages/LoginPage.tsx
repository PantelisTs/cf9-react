...
const LoginPage = () => {
    ...
    const onSubmit = async (data: LoginFields): Promise<void> => {
        try {
            ...
            toast.error(error instanceof Error ? error.message : "Something went wrong. Login failed.");
        }
    }
    ...
    return (
        <>
            <form
                ...
                className="max-w-sm mx-auto p-8 space-y-6 border rounded bg-white shadow-md shadow-cf-dark-red"
            >
